#Same as original arduino-mk but added -std=c++11 to CXXFLAGS
#so that it will build with corbomite
########################################################################
#
...
USER_LIB_PATH := () #$(realpath ./download/NewliquidCrystal)
arduino_output =
...
USER_INCLUDES       = $(patsubst %,-I%,$(USER_LIBS)) -I./download/NewliquidCrystal
...
CXXFLAGS      += -fno-exceptions --std=c++11 $(EXTRA_FLAGS) $(EXTRA_CXXFLAGS)
